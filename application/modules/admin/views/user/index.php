      ...
      <section class="col-lg-12 connectedSortable">
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <p><a href="#" class="btn btn-primary">Tambah User</a></p>
                ...
                <tbody>
                  <?php $i=1; foreach ($data as $key => $value): ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" onclick="edit(<?php echo $value->id ?>)" class="btn btn-warning" data-toggle="modal" data-target="#modal-default">
                          Edit
                        </button>
                        ...
                        <?php } ?>
                        <?php if ($value->id!=$this->session->userdata('id')){ ?>
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-sakarepmu">
                            Delete
                          </button>
                        <?php } ?>
                      </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="row">
            <form class="" action="<?php echo base_url('admin/process_edit') ?>" method="post">
              <div class="form-group">
                <label for="">Username</label>
                <input type="hidden" name="edt_id" id="edt_id" value="">
                <input type="text" class="form-control" name="edt_username" id="edt_username" placeholder="" required>
              </div>
              <div class="form-group">
...
<script type="text/javascript">
  ...
  function edit(id) {
    console.log(id);
    $.ajax({
      url: '<?php echo base_url('admin/getUser/') ?>'+id,
      type: 'GET',
      dataType: 'json'
    })
    .done(function(data) {
